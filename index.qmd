...
::: callout-note
This website was built with Quarto and includes content first drafted with an LLM, then edited and verified by me. Pages that include LLM-polished text are labeled accordingly.
:::
...
> *Accessibility note:* all images have alt text; navigation works with keyboard; external links open in a new tab.
